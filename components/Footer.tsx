  ...
  return (
    <footer className='flexCenter mb-24'>
      <div className='padding-container max-container flex w-full flex-col gap-14 '>
        ...
        <p className='regular-14 w-full text-center text-gray-30'>2023 Hilink | All rigths reserved</p>
      </div>
...
type FooterCoumnProps ={
 title:string;
 children:React.ReactNode;
}

const FooterColumns =({title,children} : FooterCoumnProps) =>{
  return(
